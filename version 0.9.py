...
def transform_data(**kwargs):
    ...
    # Sort by date
    daily_avg_df = daily_avg_df.sort_values(by='formatted_date').reset_index()
    daily_avg_df.drop('index', axis=1, inplace=True)
    ...
    daily_avg_df.to_csv(daily_transformed_file_path)
    monthly_avg_df.to_csv(monthly_transformed_file_path)
...
def validate_data(**kwargs):
    ...
    # Export to csv
    daily_avg_df.to_csv(daily_validated_file_path)
    monthly_avg_df.to_csv(monthly_validated_file_path)
