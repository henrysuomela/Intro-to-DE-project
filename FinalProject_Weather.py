...
def load_data(**kwargs):
    ...
    daily_avg_df.to_sql('daily_weather', conn, if_exists='append', index=True, index_label='id')
    monthly_avg_df.to_sql('monthly_weather', conn, if_exists='append', index=True, index_label='id')
    conn.commit()
    conn.close()
