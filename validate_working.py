...
# Outlier Detection
    temperature_outliers_daily = daily_avg_df[
        (daily_avg_df['temperature_c'] < -50) | (daily_avg_df['temperature_c'] > 50)
    ]
    if not temperature_outliers_daily.empty:
        print("Outliers detected in daily temperature data:", temperature_outliers_daily)

    temperature_outliers_monthly = monthly_avg_df[
        (monthly_avg_df['avg_temperature_c'] < -50) | (monthly_avg_df['avg_temperature_c'] > 50)
    ]
    if not temperature_outliers_monthly.empty:
        print("Outliers detected in monthly temperature data:", temperature_outliers_monthly)
